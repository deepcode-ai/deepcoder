...
from deepcoder.core.chat_to_files import chat_to_files_dict
from deepcoder.core.default.paths import CODE_GEN_LOG_FILE, ENTRYPOINT_FILE
from deepcoder.core.default.steps import curr_fn, improve_fn, setup_sys_prompt
...
def clarified_gen(
    ...
    while True:
        ...
        if not user_input or user_input == "c":
            print("(letting deepcoder make its own assumptions)")
            print()
            messages = ai.next(
                messages,
