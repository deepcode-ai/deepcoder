...
from deepcoder.applications.cli.cli_agent import CliAgent
from deepcoder.applications.cli.collect import collect_and_send_human_review
from deepcoder.applications.cli.file_selector import FileSelector
from deepcoder.core.ai import AI, ClipboardAI
from deepcoder.core.default.disk_execution_env import DiskExecutionEnv
from deepcoder.core.default.disk_memory import DiskMemory
from deepcoder.core.default.file_store import FileStore
from deepcoder.core.default.paths import PREPROMPTS_PATH, memory_path
from deepcoder.core.default.steps import (
    execute_entrypoint,
    gen_code,
    handle_improve_mode,
...
from deepcoder.core.git import stage_uncommitted_to_git
from deepcoder.core.preprompts_holder import PrepromptsHolder
from deepcoder.core.prompt import Prompt
from deepcoder.tools.custom_steps import clarified_gen, lite_gen, self_heal
...
def load_prompt(
    ...
    if prompt_str:
        ...
        if not improve_mode:
            prompt_str = input(
                "\nWhat application do you want deepcoder to generate?\n"
            )
        else:
...
def main(
    ...
    print("Running deepcoder in", path.absolute(), "\n")
