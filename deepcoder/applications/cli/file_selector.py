...
It operates within the DeepCoder environment, relying on core functionalities for
...
from deepcoder.core.default.paths import metadata_path
from deepcoder.core.files_dict import FilesDict
from deepcoder.core.git import filter_by_gitignore, is_git_repo
...
class FileSelector:
    ...
    COMMENT = (
        ...
        "# deepcoder can only read selected files. "
