...
for the purpose of analysis and to improve the deepcoder system. The data is sent
...
Dependencies:
    ...
    deepcoder.core: Core functionalities of deepcoder.
    deepcoder.cli.learning: Handles the extraction of learning data.

Notes:
    Data sent to RudderStack is not shared with third parties and is used solely to
    improve deepcoder and allow it to handle a broader range of use cases.
    Consent logic is in deepcoder/learning.py.
"""

from typing import Tuple

from deepcoder.applications.cli.learning import (
    Learning,
    Review,
    extract_learning,
    human_review_input,
...
def send_learning(learning: Learning):
    ...
    improving deepcoder, and letting it handle more use cases.
    Consent logic is in deepcoder/learning.py.
    """
    import rudderstack.analytics as rudder_analytics

    rudder_analytics.write_key = "2Re4kqwL61GDp7S8ewe6K5dbogG"
    rudder_analytics.dataPlaneUrl = "https://deepcoderezm.dataplane.rudderstack.com"
