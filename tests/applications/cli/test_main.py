...
import deepcoder.applications.cli.main as main

from deepcoder.applications.cli.main import load_prompt
from deepcoder.core.default.disk_memory import DiskMemory
from deepcoder.core.prompt import Prompt
...
class TestMain:
    #  Runs deepcoder cli interface for many parameter configurations, BUT DOES NOT CODEGEN! Only testing cli.
    ...
    #  Runs deepcoder with improve mode and improves an existing project in the specified path.
    ...
    #  Runs deepcoder with improve mode and improves an existing project in the specified path, with skip_file_selection
    ...
    #  Runs deepcoder with lite mode and generates a project with only the main prompt.
    ...
    #  Runs deepcoder with clarify mode and generates a project after discussing the specification with the AI.
    ...
    #  Runs deepcoder with self-heal mode and generates a project after discussing the specification with the AI and self-healing the code.
...
class TestLoadPrompt:
    ...
    def test_load_prompt_no_file_improve_mode_false(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch(
                "builtins.input",
                return_value="What application do you want deepcoder to generate?",
            ):
                result = load_prompt(
...
#         monkeypatch.setattr("builtins.input", lambda _: next(gen))
#         monkeypatch.setattr(
#             "deepcoder.core.default.steps.salvage_correct_hunks",
